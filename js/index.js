...
const tabs = document.querySelectorAll(".operations__tab"); // All 6 buttons
const tabsContainer = document.querySelector(".operations__tab-container"); // Container for buttons
const tabContent = document.querySelectorAll(".operations__content "); // All 6 changing tabs

tabsContainer.addEventListener("click", function (e) {
  const clicked = e.target.closest(".operations__tab"); // finds closest parent with same class name
  console.log(clicked); // other than 6 buttons, it shows null
...
/////////////////////////////////////////// 4 :: Menu fade animation [ Templates  Tips Feedback ] ///////////////////////////////////
